...
?>
<div class="modal left fade" id="modal_filter_announcement" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="modal_filter_course" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document" style="width:380px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark"><i class="mdi mdi-filter m-0 mr-1" style="font-size: 1.25rem;"></i>ตัวกรอง</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3 mt-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm text-dark" id="search_std_finder_ads" placeholder="ค้นหา" value="">
                        ...
                        <div class="col-md-12 mb-3">
                            <span class="text-nowrap mr-3 pt-2">เพศผู้เรียน</span>
                            <div class="d-flex flex-row">
                                <div class="form-check">
        ...
        $("#search_tutor_advance").click(function() {
            ...
            if (check_range == true) {
                ...
                function showPosition(position) {
                    ...
                    var search_std_finder_ads = $('#search_std_finder_ads').val() ?? '';
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            lat_U: lat_U,
                            lon_U: lon_U,
                            search_ads: search_std_finder_ads
                        },
