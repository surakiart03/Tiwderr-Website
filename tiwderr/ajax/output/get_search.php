...
if (!empty($_POST["keyword"])) {
    $sql = $conn->prepare("SELECT A.username, A.profile_name, A.profile_pic, B.role 
                            ...
                            WHERE A.profile_name LIKE  ? OR A.username LIKE  ?  ORDER BY A.profile_name");
...
?>
        ...
        ?>
            <option onClick="window.location='profile.php?username=<?php echo $row["username"]; ?>';">
                <div class="row px-3 py-1 mouse-hover-bg">
