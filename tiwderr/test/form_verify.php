          ...
          <div class="u-row-container" style="padding: 0px; background-color: transparent">
            <div class="u-row" style="
              ...
              <div style="
                  ...
                  ">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:650px;"><tr style="background-color: #e6ffff;"><![endif]-->
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="
                                        ...
                                        padding-left: 0px;
                                      " align="center">
                                    <img align="center" border="0" src="cid:email_verify" alt="Image" title="Image" style="
                                          outline: none;
                                          text-decoration: none;
                          ...
                          <tr>
                            <td style="
                              ...
                              <div align="center">
                                ...
                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://localhost/example_code/Fisho_RegLogin/verify.php?email=$email&v_code=$v_code'&gt;Verify&lt;/a&gt;" style="height:46px; v-text-anchor:middle; width:207px;" arcsize="130.5%"  stroke="f" fillcolor="#2edf7b"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Montserrat',sans-serif;"><![endif]-->
                                <a href="http://localhost/tiwderr/form_verify.php?email=<?= $email ?>&v_code=<?= $v_code ?>" target="_blank" class="v-button et_st">
                                  <span style="
                                        display: block;
